...
public class GpssewahishourServiceImpl extends ServiceImpl<GpssewahishourMapper, Gpssewahishour> implements IGpssewahishourService {
    ...
    @Override
    public Gpssewahis findOneByFactNumAndEqumNum(String factNum, String equmNum, Date beginTime, Date endTime) {
    ...
    public void genData(Date beginTime, Date endTime) {
        ...
        for (Gpssewahishour item : factsewahishours) {
            ...
            Gpssewahis factleachhis = findOneByFactNumAndEqumNum(item.getFactNum(),
     ...
     */
    @Override
    public List<Gpssewahishour> findByFactNumAndEqumNum(String factNum, String equmNum, Date beginTime, Date endTime) {
