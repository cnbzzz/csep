...
public class GenFactSewa {
    ...
    public Factsewa genOneRecord() {

        Date date = new Date();
        String timestamp = String.valueOf(date.getTime()/1000);

        Factsewa factsewahis = genPojo(Integer.parseInt(timestamp));

        factsewaService.insert(factsewahis);
        return factsewahis;

    }


    private Factsewa genPojo(Integer seq) {

        Factsewa factsewahis = new Factsewa();
